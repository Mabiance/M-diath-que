        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="form-area text-center">
                    <form id="form-contact" role="form" method="POST" action="traitement/traimod.php">

                        <br style="clear:both">
                        <h3 style="margin-bottom: 25px; text-align: center;">Modifier un film</h3>

                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Id du film:</span>
                            </div>
                            <input type="text" class="form-control" id="text" name="id" value="" placeholder="" required>
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                      ...
                      <a href="index2.php"><button type="submit" id="submit" name="submit" class="btn btn-purple">Modifier</button></a>
                    </form>
                </div>
            </div>
        </div>
