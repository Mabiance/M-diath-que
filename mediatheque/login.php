...
<div class="d-block mx-auto col-md-4 col-xs-2">
    ...
    <div class="form-area text-center">
        <form id="form-contact" role="form" method="POST" action="traitement/trailogin.php">
            <br style="clear:both">
            ...
            <button type="submit" id="submit" name="submit" class="btn btn-purple">Connexion</button><br><br>
            <img class="mx-auto d-block" src="images/co.png" height="130px" width="250px" />
        </form>
    </div>
</div>
